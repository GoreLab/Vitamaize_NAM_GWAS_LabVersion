...
#Write out the results, put the in the same directory as the JL results from TASSEL
 ...
 #write.table(pop.by.marker.effects, paste(popByMarker.path,"Pop.by.Marker.Effect.Estimates.from.R.",i,".SI01_redo_ExtValRemoved_newTrans.txt", sep = ""), sep = "\t", row.names = FALSE, quote = FALSE) #for dT3 redo
