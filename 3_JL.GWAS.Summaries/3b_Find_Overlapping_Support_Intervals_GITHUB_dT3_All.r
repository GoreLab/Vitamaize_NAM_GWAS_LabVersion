...
the.data = read.table(paste(tabSummary.path,"Tabular_Summary_of_JL_",trait.set,"_Results_for_all_traits_SI01_newPVEv2_corrsigns_dT3_Redone_Sorted.txt", sep =""), sep = "\t",stringsAsFactors=F,head=T)
...
write.table(the.data.final,paste(tabSummary.path,"Tab_Sum_Final_dT3_Redone_with_Common_SI_Info_left_bound.txt",sep=''), 
